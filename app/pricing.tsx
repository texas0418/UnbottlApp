...
export default function PricingScreen() {
  ...
  const handleSelectPlan = async (plan: typeof PLANS[0]) => {
    ...
    try {
      console.log("Calling checkout with:", JSON.stringify({ restaurant_id: restaurant.id, plan: plan.id, restaurant_name: restaurant.name }));
      ...
      const errorMsg = err?.context?.body ? JSON.parse(err.context.body)?.error : err.message;
