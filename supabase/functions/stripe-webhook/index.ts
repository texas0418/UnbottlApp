...
// ─── Event handlers ───────────────────────────────────────────────────
//
// One handler per Stripe event type, registered in EVENT_HANDLERS below.
// A handler returning early is equivalent to the old `break`: the request
// still answers 200. Anything thrown propagates to serve()'s catch, which
